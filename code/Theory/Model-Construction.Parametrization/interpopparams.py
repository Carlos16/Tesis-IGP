...
def alfa(m2,alfa0,pv,pd,D,g):
    return alfa0*m2**(pv+2*(D-1)*pd)*g
...
def set_alfa(m2,alfa0,k_,pv,pd,T1,T2,E1,E2,D,v01,v02,g,alfa,fm,thermy1,thermy2,k):
    g_ = g(k_,pv,pd,T1,T2,E1,E2,D,v01,v02,fm,thermy1,thermy2,k)
    alfa_=alfa(m2,alfa0,pv,pd,D,g_)
    return alfa_
