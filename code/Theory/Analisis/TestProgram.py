...
params1={'w':0.75,'pd':0.21,'pv':0.26,'Er':0.,'Ek':0.,'ER':0.,
        ...
        'TP':300.,'D_R':2.,'D_C':2.,'fmC':'Active','thermyR':'Ecto',
        'thermyC':'Ecto','thermyP':'Ecto','fmPC':'Active','fmPR':'Active','k0':1.00,'r0':1.71e-6,'a012':10**(-3.08),
        'a03':10**(-3.08),'d0':3.,'q10':4.15e-8,'q20':4.15e-8,'v0R':1.,'v0C':1,'v0P':1,'k':b_k,'e1':0.6,'e2':0.4,'e3':0.5,
