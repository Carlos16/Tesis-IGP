...
dimDict = {2:'2D',3:'3D'}
TotalParamsExplored = { 'D_C':[2.,3.],'D_R':[2.,3.],'k0':[3.,30.,300.,0.01,0.1,1.],'b':[0.02,0.2,2.],'fmPC':['Active','Sit'],'fmC':['Active','Grazing'],'fmPR':['Active','Grazing','Sit'],'e_1':[0.3,0.6],'e_2':[0.1,0.4],
                      'e_3':[0.5]}
ParamsDirCoder = CreateDirCoder(TotalParamsExplored,dimDict)
AuxiliarParams = {'D':{'2D':{'k0':[0.01,0.1,1.],'alfa012':[10**(-3.08)],'alfa03':[10**(-3.08)],'pd':[0.21]},
                       '3D':{'k0':[3.,30.,300.],'alfa012':[10**(-1.77)],'alfa03':[10**(-1.77)],'pd':[0.2]}},
...
SpecialParams= {'D':{'2D':{'D_C':2.,'D_R':2.},'3D':{'D_C':3,'D_R':3.}},
               ...
               'e':{'comb1':{'e_1':0.3,'e_2':0.1,'e_3':0.5},
                    'comb23':{'e_1':0.6,'e_2':0.4,'e_3':0.5}}}
Comb = MakeTotalParamsCombination(ParamsToExplore,AuxiliarParams,SpecialParams)
initDirection="./NewData/"
