...
I51 = InvP4B2(KRC,KCP,e1,e2,e3,alfa0,pv,pd,k0,r0,q10,q20,0.02,D_R,w,'Grazing','Active','Grazing')
I61 = InvP4B2(KRC,KCP,e11,e21,e3,alfa0,pv,pd,k0,r0,q10,q20,0.02,D_R,w,'Sit','Sit','Active')
I71 = InvP4B2(KRC,KCP,e11,e21,e3,alfa0,pv,pd,k0,r0,q10,q20,0.02,D_R,w,'Active','Active','Active')


I52 = InvP4B2(KRC,KCP,e1,e2,e3,alfa0,pv,pd,k0,r0,q10,q20,0.2,D_R,w,'Grazing','Active','Grazing')
I62 = InvP4B2(KRC,KCP,e11,e21,e3,alfa0,pv,pd,k0,r0,q10,q20,0.2,D_R,w,'Sit','Sit','Active')
I72 = InvP4B2(KRC,KCP,e11,e21,e3,alfa0,pv,pd,k0,r0,q10,q20,0.2,D_R,w,'Active','Active','Active')

I53 = InvP4B2(KRC,KCP,e1,e2,e3,alfa0,pv,pd,k0,r0,q10,q20,2,D_R,w,'Grazing','Active','Grazing')
I63 = InvP4B2(KRC,KCP,e11,e21,e3,alfa0,pv,pd,k0,r0,q10,q20,2,D_R,w,'Sit','Sit','Active')
I73 = InvP4B2(KRC,KCP,e11,e21,e3,alfa0,pv,pd,k0,r0,q10,q20,2,D_R,w,'Active','Active','Active')


#2D

I512 = InvP4B2(KRC,KCP,e1,e2,e3,alfa02,pv,pd2,k02,r0,q10,q20,0.02,D_R2,w,'Grazing','Active','Grazing')
I612 = InvP4B2(KRC,KCP,e11,e21,e3,alfa02,pv,pd2,k02,r0,q10,q20,0.02,D_R2,w,'Sit','Sit','Active')
I712 = InvP4B2(KRC,KCP,e11,e21,e3,alfa02,pv,pd2,k02,r0,q10,q20,0.02,D_R2,w,'Active','Active','Active')


I522 = InvP4B2(KRC,KCP,e1,e2,e3,alfa02,pv,pd2,k02,r0,q10,q20,0.2,D_R2,w,'Grazing','Active','Grazing')
I622 = InvP4B2(KRC,KCP,e11,e21,e3,alfa02,pv,pd2,k02,r0,q10,q20,0.2,D_R2,w,'Sit','Sit','Active')
I722 = InvP4B2(KRC,KCP,e11,e21,e3,alfa02,pv,pd2,k02,r0,q10,q20,0.2,D_R2,w,'Active','Active','Active')

I532 = InvP4B2(KRC,KCP,e1,e2,e3,alfa02,pv,pd2,k02,r0,q10,q20,2,D_R2,w,'Grazing','Active','Grazing')
I632 = InvP4B2(KRC,KCP,e11,e21,e3,alfa02,pv,pd2,k02,r0,q10,q20,2,D_R2,w,'Sit','Sit','Active')
I732 = InvP4B2(KRC,KCP,e11,e21,e3,alfa02,pv,pd2,k02,r0,q10,q20,2,D_R2,w,'Active','Active','Active')
